...
public class CSVOperations {
	...
	public enum FileName
	{
		...
		Sprint_SSNWithoutDeposit,
		SprintServiceProviderVerification,
		Sprint2yrUpgrade,
		Sprint_IPhone5C,
		Sprint_4GPhone,
		SprintBuddyUpgrade,
		SprintEasyPayUpgrade
	}
	...
	public String GetSpvDetails() throws IOException {
		File file = new File(ResolveFileName(FileName.SprintServiceProviderVerification));
		BufferedReader br = new BufferedReader(new FileReader(file));
		String spv = null;
		String line = null;
		String[] values = null;
	...
	public IMEIDetails GetIMEIAndProductName(FileName FileName) throws IOException {
	...
	public String GenerateRandomNoForNumberPorting() throws IOException {
		String NPANXXno = PageBase.CSVOperations().GetIMEIOrSimNumberOrReceiptId(FileName.NPA_NXX);
		String randomphNumber =  String.valueOf((long)(Math.floor(Math.random() * 9000000000L) + 6000000000L));
		randomphNumber = randomphNumber.substring(0,4);
		return NPANXXno + randomphNumber;
	}
}