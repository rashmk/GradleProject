...
public class ControlLocators {
	...
	public static final String DOWN_PAYMENT_AMOUNT_LABEL = "//span[contains(text(),'Down Payment Amount:')]";
	public static final String MONTHLY_DEVICE_INSTALLMENT_BALANCE_LABEL = "//span[contains(text(),'Monthly Device Installment Balance:')]";
	public static final String MONTHLY_RECURRING_FEE_CART_LABEL = "//span[contains(text(),'Monthly Recurring Fee:')]";
	public static final String TOTAL_DUE_TODAY_label = "//span[contains(text(),'Total Due Today:')]";
	...
	public static final String DOWN_PAYMENT_FOR_SPRINT_EASY_PAY_LABEL = "//div[contains(text(),'Down Payment for Sprint Easy Pay:')]";
	public static final String LAST_MONTH_INSTALLMENT_LABEL = "//div[contains(text(),'Last Month Installment:')]";
	...
	public static final String MONTHLYINSTALLMENT_RADIOBUTTON="(//input[contains(@id, 'radio')])[1]";
