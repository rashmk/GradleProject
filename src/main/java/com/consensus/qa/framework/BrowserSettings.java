...
public class BrowserSettings extends TestListenerAdapter{
	...
	public static String readConfig(String keyName) {
		try {
			...
			FileReader reader = new FileReader("src\\test\\resources\\TestSettings.properties");
	...
	public static String readPageName(String keyName) {
		try {
			Properties configFile = new Properties();
			FileReader reader = new FileReader("//src//test//resources//pageName.properties");
			configFile.load(reader);
			return configFile.getProperty(keyName);
		} 
		catch (Exception e) {
