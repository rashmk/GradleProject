...
public class UECAddLinesPage extends RetailBaseClass{
	...
	public void selectingFirstBuddyUpgradeLine()
	{
		...
		try
		{
			Utilities.dropdownSelect(PageBase.UECAddLinesPage().pleaseSelectAnEligibleDonor1Dropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "1" );
		}
		catch (Exception e)
		{
			try
			{
				Utilities.dropdownSelect(PageBase.UECAddLinesPage().pleaseSelectAnEligibleDonor2Dropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "1" );
			}
			catch (Exception ee)
			{
				try
				{
					Utilities.dropdownSelect(PageBase.UECAddLinesPage().pleaseSelectAnEligibleDonor3Dropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "1" );
				}
				catch (Exception eee)
				{
					try
					{
						Utilities.dropdownSelect(PageBase.UECAddLinesPage().pleaseSelectAnEligibleDonor4Dropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "1" );
					}
					catch (Exception eeee)
					{
						try
						{
							Utilities.dropdownSelect(PageBase.UECAddLinesPage().pleaseSelectAnEligibleDonor5Dropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "1" );
						}
						catch (Exception eeeee)
						{
							try
							{
								Utilities.dropdownSelect(PageBase.UECAddLinesPage().pleaseSelectAnEligibleDonor6Dropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "1" );
							}
							catch (Exception eeeeee)
							{
								try
								{
									Utilities.dropdownSelect(PageBase.UECAddLinesPage().pleaseSelectAnEligibleDonor7Dropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "1" );
								}
								catch (Exception eeeeeee)
								{
									try
									{
										Utilities.dropdownSelect(PageBase.UECAddLinesPage().pleaseSelectAnEligibleDonor8Dropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "1" );
									}
									catch (Exception eeeeeeee)
									{
										try
										{
											Utilities.dropdownSelect(PageBase.UECAddLinesPage().pleaseSelectAnEligibleDonor9Dropdown, Utilities.SelectDropMethod.SELECTBYINDEX, "1" );
										}
										catch (Exception eeeeeeeee)
										{
											Log.error("No buddy upgrade option is available");
											System.out.println("No buddy upgrade option is available");
											Assert.assertTrue(false);
										}
									}
								}
